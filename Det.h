...
#if ((DET_AR_MAJOR_VERSION != STD_TYPES_AR_RELEASE_MAJOR_VERSION) || (DET_AR_MINOR_VERSION != STD_TYPES_AR_RELEASE_MINOR_VERSION) || (DET_AR_PATCH_VERSION != STD_TYPES_AR_RELEASE_PATCH_VERSION))
